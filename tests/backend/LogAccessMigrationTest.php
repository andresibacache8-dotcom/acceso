<?php
/**
 * tests/backend/LogAccessMigrationTest.php
 *
 * Tests de migración para log_access-migrated.php
...
class LogAccessMigrationTest extends TestCase
{
    ...
    {
        $this->apiPath = __DIR__ . '/../../api/log_access-migrated.php';
    ...
    {
        $this->assertFileExists($this->apiPath, 'log_access-migrated.php debe existir');
    }
    ...
    public function testTableExists(): void
    {
        try {
            ...
            $result = $conn->query("SELECT 1 FROM log_access LIMIT 1");
            $this->assertNotFalse($result, 'Tabla log_access debe existir');
