<?php
/**
 * tests/backend/PorticoMigrationTest.php
 *
 * Tests de migración para portico-migrated.php
...
class PorticoMigrationTest extends TestCase
{
    ...
    {
        $this->apiPath = __DIR__ . '/../../api/portico-migrated.php';
    ...
    {
        $this->assertFileExists($this->apiPath, 'portico-migrated.php debe existir');
    }
    ...
    /**
     * Test 7: Verificar control de acceso
     */
    public function testImplementsAccessControl(): void
    {
        $content = file_get_contents($this->apiPath);
        ...
        $this->assertStringContainsString(
            'permitido',
            $content,
            'Debe verificar acceso permitido'
        );
    }
    ...
    public function testTableExists(): void
    {
        try {
            ...
            $result = $conn->query("SELECT 1 FROM portico LIMIT 1");
            $this->assertNotFalse($result, 'Tabla portico debe existir');
