<?php
/**
 * tests/backend/ComisionMigrationTest.php
 *
 * Tests de migración para comision-migrated.php
...
class ComisionMigrationTest extends TestCase
{
    ...
    {
        $this->apiPath = __DIR__ . '/../../api/comision-migrated.php';
    ...
    {
        $this->assertFileExists($this->apiPath, 'comision-migrated.php debe existir');
    }
    ...
    public function testTableExists(): void
    {
        try {
            ...
            $result = $conn->query("SELECT 1 FROM comision LIMIT 1");
            $this->assertNotFalse($result, 'Tabla comision debe existir');
