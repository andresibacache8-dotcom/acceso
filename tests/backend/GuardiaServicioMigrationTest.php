<?php
/**
 * tests/backend/GuardiaServicioMigrationTest.php
 *
 * Tests de migración para guardia-servicio-migrated.php
...
class GuardiaServicioMigrationTest extends TestCase
{
    ...
    {
        $this->apiPath = __DIR__ . '/../../api/guardia-servicio-migrated.php';
    ...
    {
        $this->assertFileExists($this->apiPath, 'guardia-servicio-migrated.php debe existir');
    }
     ...
     */
    public function testImplementsFilters(): void
    {
        $content = file_get_contents($this->apiPath);
    ...
    /**
     * Test 10: Verificar tabla guardia_servicio
     */
    public function testTableExists(): void
    {
        try {
            ...
            $this->assertNotFalse($result, 'Tabla guardia_servicio debe existir');
    ...
    /**
     * Test 11: Verificar estructura de tabla
     */
    public function testTableStructure(): void
    {
        try {
            ...
            $result = $conn->query("DESCRIBE guardia_servicio");
            $columns = [];
            ...
            $required = ['id', 'tipo', 'personal_id', 'status'];
            foreach ($required as $col) {
                $this->assertContains($col, $columns, "Columna '$col' debe existir");
            }
